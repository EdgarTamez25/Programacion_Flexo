      ...
      <v-col cols="12">
        ...
        <v-card outlined class="pa-3">
          <v-row class="pa-1 py-0">
						<v-col cols="12"  md="6" >
							<v-card-actions class="font-weight-black headline  py-0 mt-1 " > OFFSET  </v-card-actions>
						</v-col>
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.Parametros_Offset.length){
				this.estatus  = { id: this.Parametros_Offset.estatus };
				this.fecha1   = this.Parametros_Offset.fecha1;
				this.fecha2   = this.Parametros_Offset.fecha2;
			}
      this.init();
    },
    ...
    computed:{
			...mapGetters('PrograDepto' ,['Loading','Parametros_Offset','Offset']), // IMPORTANDO USO DE VUEX - (GETTERS)
    ...
    methods:{ 
      ...mapActions('PrograDepto' ,['obtener_Programaciones_Offset','finalizar_Producto_Offset']), 
      ...
      init(){
        ...
        this.obtener_Programaciones_Offset(payload)
      },
      ...
      finalizarOT(){
        ...
        this.finalizar_Producto_Offset(payload).then(response =>{
      ...
      guardarMaquina(item){
        this.$http.put('actualiza.maquina.offset/'+ item.id, item);
        this.init();
      }
    }
