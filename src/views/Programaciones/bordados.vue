      ...
      <v-col cols="12">
        ...
        <v-card outlined class="pa-3">
          <v-row class="pa-1 py-0">
						<v-col cols="12"  md="6" >
							<v-card-actions class="font-weight-black headline  py-0 mt-1 " > BORDADOS  </v-card-actions>
						</v-col>
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.Parametros_Bordados.length){
				this.estatus  = { id: this.Parametros_Bordados.estatus };
				this.fecha1   = this.Parametros_Bordados.fecha1;
				this.fecha2   = this.Parametros_Bordados.fecha2;
			}
      this.init();
    },
    ...
    computed:{
			...mapGetters('PrograDepto' ,['Loading','Parametros_Bordados','Bordados']), // IMPORTANDO USO DE VUEX - (GETTERS)
    ...
    methods:{ 
      ...mapActions('PrograDepto' ,['obtener_Programaciones_Bordados','finalizar_Producto_Bordados']), 
      ...
      init(){
        ...
        this.obtener_Programaciones_Bordados(payload)
      },
      ...
      finalizarOT(){
        ...
        this.finalizar_Producto_Bordados(payload).then(response =>{
      ...
      guardarMaquina(item){
        this.$http.put('actualiza.maquina.bordados/'+ item.id, item);
        this.init();
      }
    }
