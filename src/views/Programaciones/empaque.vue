      ...
      <v-col cols="12">
        ...
        <v-card outlined class="pa-3">
          <v-row class="pa-1 py-0">
						<v-col cols="12"  md="6" >
							<v-card-actions class="font-weight-black headline  py-0 mt-1 " > EMPAQUE </v-card-actions>
						</v-col>
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.Parametros_Empaque.length){
				this.estatus  = { id: this.Parametros_Empaque.estatus };
				this.fecha1   = this.Parametros_Empaque.fecha1;
				this.fecha2   = this.Parametros_Empaque.fecha2;
			}
      this.init();
    },
    ...
    computed:{
			...mapGetters('PrograDepto' ,['Loading','Parametros_Empaque','Empaque']), // IMPORTANDO USO DE VUEX - (GETTERS)
    ...
    methods:{ 
      ...mapActions('PrograDepto' ,['obtener_Programaciones_Empaque','finalizar_Producto_Empaque']), 
      ...
      init(){
        ...
        this.obtener_Programaciones_Empaque(payload)
      },
      ...
      finalizarOT(){
        ...
        this.finalizar_Producto_Empaque(payload).then(response =>{
      ...
      guardarMaquina(item){
        this.$http.put('actualiza.maquina.empaque/'+ item.id, item);
        this.init();
      }
    }
