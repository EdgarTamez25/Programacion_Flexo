      ...
      <v-col cols="12">
        ...
        <v-card outlined class="pa-3">
          <v-row class="pa-1 py-0">
						<v-col cols="12"  md="6" >
							<v-card-actions class="font-weight-black headline  py-0 mt-1 " > SERIGRAFÍA </v-card-actions>
						</v-col>
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.Parametros_Serigrafia.length){
				this.estatus  = { id: this.Parametros_Serigrafia.estatus };
				this.fecha1   = this.Parametros_Serigrafia.fecha1;
				this.fecha2   = this.Parametros_Serigrafia.fecha2;
			}
      this.init();
    },
    ...
    computed:{
			...mapGetters('PrograDepto' ,['Loading','Parametros_Serigrafia','Serigrafia']), // IMPORTANDO USO DE VUEX - (GETTERS)
    ...
    methods:{ 
      ...mapActions('PrograDepto' ,['obtener_Programaciones_Serigrafia','finalizar_Producto_Serigrafia']), 
      ...
      init(){
        ...
        this.obtener_Programaciones_Serigrafia(payload)
      },
      ...
      finalizarOT(){
        ...
        this.finalizar_Producto_Serigrafia(payload).then(response =>{
      ...
      guardarMaquina(item){
        this.$http.put('actualiza.maquina.serigrafia/'+ item.id, item);
        this.init();
      }
    }
