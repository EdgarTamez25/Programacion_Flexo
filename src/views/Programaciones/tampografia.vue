      ...
      <v-col cols="12">
        ...
        <v-card outlined class="pa-3">
          <v-row class="pa-1 py-0">
						<v-col cols="12"  md="6" >
							<v-card-actions class="font-weight-black headline  py-0 mt-1 " > TAMPOGRAFÍA </v-card-actions>
						</v-col>
...
<script>
  ...
  export default {
    ...
    created(){
      ...
      if(this.Parametros_Tampografia.length){
				this.estatus  = { id: this.Parametros_Tampografia.estatus };
				this.fecha1   = this.Parametros_Tampografia.fecha1;
				this.fecha2   = this.Parametros_Tampografia.fecha2;
			}
      this.init();
    },
    ...
    computed:{
			...mapGetters('PrograDepto' ,['Loading','Parametros_Tampografia','Tampografia']), // IMPORTANDO USO DE VUEX - (GETTERS)
    ...
    methods:{ 
      ...mapActions('PrograDepto' ,['obtener_Programaciones_Tampografia','finalizar_Producto_Tampografia']), 
      ...
      init(){
        ...
        this.obtener_Programaciones_Tampografia(payload)
      },
      ...
      finalizarOT(){
        ...
        this.finalizar_Producto_Tampografia(payload).then(response =>{
      ...
      guardarMaquina(item){
        this.$http.put('actualiza.maquina.tampografia/'+ item.id, item);
        this.init();
      }
    }
